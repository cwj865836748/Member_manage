...
const name = defaultSettings.title || 'EZT-CMS0' // page title

// If your port is set to 80,
// use administrator privileges to execute the command line.
// For example, Mac: sudo npm run
// You can change the port by the following method:
// port = 9801 npm run dev OR npm run dev --port = 9801
const port = process.env.port || process.env.npm_config_port || 9801 // dev port
